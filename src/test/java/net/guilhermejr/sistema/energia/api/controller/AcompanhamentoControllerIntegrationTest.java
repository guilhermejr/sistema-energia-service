...
public class AcompanhamentoControllerIntegrationTest {
    ...
    public void deve_retornar_um_acompanhamento_quando_id_existente() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/acompanhamentos/{id}", acompanhamento.getId())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.tusdReal").value(EntityFactory.acompanhamento1.getTusdReal().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.te").value(EntityFactory.acompanhamento1.getTe().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.teReal").value(EntityFactory.acompanhamento1.getTeReal().toString()))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.iluminacaoPublicaReal").value(EntityFactory.acompanhamento1.getIluminacaoPublicaReal().toString()))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.valorTotalReal").value(EntityFactory.acompanhamento1.getValorTotalReal().toString()))
    ...
    public void deve_inserir_um_acompanhamento() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/acompanhamentos")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.tusdReal").value("293.68"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.te").value("19.1"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.teReal").value("166.75"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.iluminacaoPublicaReal").value("102.82"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.desconto").value("0"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.valorTotal").value("54.48"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.valorTotalReal").value("563.25"))
